...
// Returns the private 'App\Repository\QuestionAppRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\QuestionAppRepository.php';

return $this->privates['App\Repository\QuestionAppRepository'] = new \App\Repository\QuestionAppRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
