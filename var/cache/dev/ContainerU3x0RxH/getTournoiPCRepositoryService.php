...
// Returns the private 'App\Repository\TournoiPCRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TournoiPCRepository.php';

return $this->privates['App\Repository\TournoiPCRepository'] = new \App\Repository\TournoiPCRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
