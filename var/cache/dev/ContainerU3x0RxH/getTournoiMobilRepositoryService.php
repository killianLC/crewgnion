...
// Returns the private 'App\Repository\TournoiMobilRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TournoiMobilRepository.php';

return $this->privates['App\Repository\TournoiMobilRepository'] = new \App\Repository\TournoiMobilRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
