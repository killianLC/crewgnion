...
// Returns the private 'App\Repository\QuestionTournoiRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\QuestionTournoiRepository.php';

return $this->privates['App\Repository\QuestionTournoiRepository'] = new \App\Repository\QuestionTournoiRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
