...
// Returns the private 'App\Repository\AcquerirRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\AcquerirRepository.php';

return $this->privates['App\Repository\AcquerirRepository'] = new \App\Repository\AcquerirRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
