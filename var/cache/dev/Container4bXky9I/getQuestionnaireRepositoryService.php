...
// Returns the private 'App\Repository\QuestionnaireRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\QuestionnaireRepository.php';

return $this->privates['App\Repository\QuestionnaireRepository'] = new \App\Repository\QuestionnaireRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
