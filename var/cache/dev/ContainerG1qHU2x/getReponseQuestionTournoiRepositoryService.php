...
// Returns the private 'App\Repository\ReponseQuestionTournoiRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ReponseQuestionTournoiRepository.php';

return $this->privates['App\Repository\ReponseQuestionTournoiRepository'] = new \App\Repository\ReponseQuestionTournoiRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
