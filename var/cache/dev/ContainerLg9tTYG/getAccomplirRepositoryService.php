...
// Returns the private 'App\Repository\AccomplirRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\AccomplirRepository.php';

return $this->privates['App\Repository\AccomplirRepository'] = new \App\Repository\AccomplirRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
