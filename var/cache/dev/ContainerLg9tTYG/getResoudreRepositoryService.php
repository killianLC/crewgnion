...
// Returns the private 'App\Repository\ResoudreRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ResoudreRepository.php';

return $this->privates['App\Repository\ResoudreRepository'] = new \App\Repository\ResoudreRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
