...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\AccomplirRepository' => function () {
    return ($this->privates['App\Repository\AccomplirRepository'] ?? $this->load('getAccomplirRepositoryService.php'));
}, 'App\\Repository\\AcquerirRepository' => function () {
    return ($this->privates['App\Repository\AcquerirRepository'] ?? $this->load('getAcquerirRepositoryService.php'));
}, 'App\\Repository\\GradeRepository' => function () {
...
}, 'App\\Repository\\ResoudreRepository' => function () {
    return ($this->privates['App\Repository\ResoudreRepository'] ?? $this->load('getResoudreRepositoryService.php'));
