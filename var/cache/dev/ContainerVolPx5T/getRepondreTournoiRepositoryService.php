...
// Returns the private 'App\Repository\RepondreTournoiRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\RepondreTournoiRepository.php';

return $this->privates['App\Repository\RepondreTournoiRepository'] = new \App\Repository\RepondreTournoiRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
