...
// Returns the private 'App\Repository\SalarieRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\SalarieRepository.php';

return $this->privates['App\Repository\SalarieRepository'] = new \App\Repository\SalarieRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
