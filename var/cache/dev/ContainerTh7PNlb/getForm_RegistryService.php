...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\InscriptonType' => function () {
    return ($this->privates['App\Form\InscriptonType'] ?? $this->privates['App\Form\InscriptonType'] = new \App\Form\InscriptonType());
