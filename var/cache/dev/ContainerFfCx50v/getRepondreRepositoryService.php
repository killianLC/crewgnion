...
// Returns the private 'App\Repository\RepondreRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\RepondreRepository.php';

return $this->privates['App\Repository\RepondreRepository'] = new \App\Repository\RepondreRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
