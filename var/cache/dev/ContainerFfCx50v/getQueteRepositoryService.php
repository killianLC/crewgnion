...
// Returns the private 'App\Repository\QueteRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\QueteRepository.php';

return $this->privates['App\Repository\QueteRepository'] = new \App\Repository\QueteRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
